...
public class JobController {
    ...
    public String add(Model model, @Valid JobForm jobForm, Errors errors) {
        ...
        //create new job and pull attributes from jobForm add set to new job
        Job newJob = new Job();
        ...
        //add job to JobData model
        jobData.add(newJob);

        //get id for new job and redirect to job/ so it can render single job with ?id=#
        int id = newJob.getId();
